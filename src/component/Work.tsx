  ...
  return (
    <div id='work'  className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <h2 className={`text-center text-4xl ${Styles.FontOvo} `}>My latest work</h2>
       ...
       <a href="" className={`w-max flex items-center justify-center gap-2 text-gray-700 border-[0.7px] border-gray-700 rounded-full py-3 px-10 mx-auto  my-20 ${Styles.HoverLightHover}  duration-500`} >
