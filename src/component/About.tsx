      ...
      <div  className='flex w-full flex-col lg:flex-row items-center gap-20 my-20' >
        ...
        <div className='flex-1' >
          <p>
            ...
            Currently pursuing my Bachelor's in Software Engineering (BSSE), I am sharpening my full-stack development skills through the MERN Stack Development program at SMIT (Saylani Mass IT Training).
          </p>
