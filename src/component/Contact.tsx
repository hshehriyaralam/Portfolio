...
export default function Contact ()  {
  ...
  return (
    <div  id='contact'  className={`w-full px-[10%] py-8 scroll-mt-20  ${themeValue ? `bg-[url("/footer-bg-color.png")]`   : 'bg-transparent' }   bg-no-repeat bg-center bg-[length : 90%_auto]`}>
